...
const StatusBar: React.FC<StatusBarProps> = ({ turn, resources }) => (
	<div className="bg-opacity-70 flex w-full items-center justify-between border-b border-purple-700/40 bg-gradient-to-r from-purple-900/80 to-slate-900/80 px-6 py-3 font-mono text-base tracking-wide text-white shadow-lg backdrop-blur-md">
