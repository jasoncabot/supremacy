/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7c46914aa8eb67554ed0c704adef7ac6)
// Runtime types generated with workerd@1.20260521.1 2025-05-08 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SIGNUPS_ENABLED: "true" | "";
	GAMES: DurableObjectNamespace<import("./worker/index").GamesDurableObject>;
	MATCHMAKER: DurableObjectNamespace<import("./worker/index").MatchmakerDurableObject>;
	USERS: DurableObjectNamespace<import("./worker/index").UsersDurableObject>;
	TOKENS: DurableObjectNamespace<import("./worker/index").TokensDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GamesDurableObject" | "MatchmakerDurableObject" | "UsersDurableObject" | "TokensDurableObject";
	}
	interface DevEnv {
		ASSETS: Fetcher;
		SIGNUPS_ENABLED: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SIGNUPS_ENABLED">> {}
}
